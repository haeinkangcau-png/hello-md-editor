...
export default function Toolbar({ editor }) {
  ...
  return (
    <div className="toolbar">
      ...
      {/* 들여쓰기 / 내어쓰기 — 여러 항목·여러 depth 선택 시 일괄 적용(범위 기반) */}
      <Btn title="들여쓰기 (Tab)"
        disabled={!editor.can().sinkListItem('listItem')}
        onClick={cmd(() => editor.chain().sinkListItem('listItem').run())}>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <line x1="10" y1="6" x2="21" y2="6"/><line x1="10" y1="12" x2="21" y2="12"/>
          <line x1="10" y1="18" x2="21" y2="18"/><polyline points="3 8 7 12 3 16"/>
        </svg>
      </Btn>
      <Btn title="내어쓰기 (Shift+Tab)"
        disabled={!editor.can().liftListItem('listItem')}
        onClick={cmd(() => editor.chain().liftListItem('listItem').run())}>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <line x1="10" y1="6" x2="21" y2="6"/><line x1="10" y1="12" x2="21" y2="12"/>
          <line x1="10" y1="18" x2="21" y2="18"/><polyline points="7 8 3 12 7 16"/>
        </svg>
      </Btn>
